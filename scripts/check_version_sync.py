...
TOUCHPOINTS: list[tuple[str, str, str, int]] = [
    ...
    (
        "bindings/csharp/WickraTimeMachine/WickraTimeMachine.csproj",
        "NuGet version",
        r"<Version>@V@</Version>",
        1,
    ),
    ...
    ("examples/README.md", "sample output", r"wickra-timemachine @V@", 1),
    ...
    (
        ...
        r'"name": "wickra-timemachine",\s+"version": "@V@"',
        2,
    ),
]
